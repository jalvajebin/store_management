...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/web/style.css') }}">
      ...
      <div class="row justify-content-between align-items-center w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand text-white" href="{{ route('home.index') }}">
              <img src="{{ asset('assets/web/images/main.jpg') }}" alt="logo" style="width: 100px; height: auto; border-radius: 50%; margin: 10px;">
          </a>
        </div>
              ...
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="dropdownShop" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Stores</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <section id="billboard" class="bg-light py-5">
    <div class="container">
      <div class="row justify-content-center">
        <h1 class="section-title text-center mt-4" data-aos="fade-up">Stores Near You</h1>
...
<hr/>
      ...
      <div class="row d-flex flex-wrap justify-content-between py-5">
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
            ...
            <p>Do you have any questions or suggestions? <a href="mailto:contact@johndoe.com"
                class="item-anchor">contact@johndoe.com</a></p>
  ...
  <script src="{{ asset('assets/web/js/script.min.js') }}"></script>
</body>
